...
import Chapter_10_Working_With_Data_Manipulation.Python_Code.hfpy_utils as hfpy_utils
...
def event_lookup(event):
    ...
    Give an event descriptor (the name of a swimmer's file), convert the descriptor into a lookup key which can be used
    with the "records" dictionary.
    """
    conversions = {
        "Free": "freestyle",
        "Back": "backstroke",
